  ...
  return (<Provider store={store}>
    <div className={s.appWrap}>
      <Header logoImg={<HeaderIcon/>} logoLink={"https://ui-kit.it-incubator.io/?path=/story/components-data-display-card--primary-with-icon"}>
        {isLogedIn ? <CustomDropdownMenu triggerContent={<Button className={s.btnMenu}><img src={"https://banner2.cleanpng.com/20180707/puq/kisspng-computer-icons-avatar-clip-art-5b40601d5c8c75.9330992415309455653791.jpg"} className={s.avatar}/></Button>}>
